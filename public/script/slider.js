...
function Slider(application, div, options){
    ...
    this.options = $.extend({
        ...
        linecolor:"#9E9E9E",
        labelcolor:"#808080",
        labelhovercolor:"#505050",
        labelselectedcolor:"#FE7060",
        font:"12pt Calibri",
    ...
    var self = this;
    $(this.canvas).mousemove(function(e){self.mousemove(e)});
    $(this.canvas).mouseleave(function(e){self.mouseleave();})
    $(this.canvas).click(function(e){self.mouseclick(e);})
...
Slider.prototype = {
    ...
    draw: function(){
        ...
        this.ctx.fillRect(margin, baseline, this.width-2*margin, 2);
    ...
    drawLabel: function(x, y, width, value, selected, hover){
        ...
        this.ctx.fillText(value, x, y+width*2);
